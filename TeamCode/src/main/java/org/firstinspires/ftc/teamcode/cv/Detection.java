...
public class Detection extends OpenCvPipeline {
    ...
    public Mat markRings(Mat input, ArrayList<Stack> rectsData){
        ...
        for(Stack stack: rectsData){
            if(stack.count > 0){
                ...
                Imgproc.rectangle(copy, stack.fullStack.tl(), stack.fullStack.br(), new Scalar(255, 255, 0), 2);
                Imgproc.putText(copy, "" + stack.count,
    ...
    // Assuming Mecanum is integrated
//    public void faceObjectInc(Point target){
